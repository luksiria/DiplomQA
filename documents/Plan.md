...
>* _владелец (имя фамилия на латинском или на кириллице);_
>* _cvv код - 3 цифры._
...
**9) Оплата по карте c невалидным сроком действия карты (ввод символов на кириллице), обычная покупка:**
- на странице сервиса нажать кнопку "Купить";
- ввести валидный номер карты;
- ввести валидные данные в поле "Владелец";
...
**10) Оплата по карте c невалидным сроком действия карты (ввод символов на латинице), обычная покупка:**
- на странице сервиса нажать кнопку "Купить";
- ввести валидный номер карты;
- ввести валидные данные в поле "Владелец";
...
**11). Оплата по карте c невалидным полем владелец (ввод цифр), обычная покупка:**
- на странице сервиса нажать кнопку "Купить";
- ввести валидный номер карты;
...
**12) Оплата по карте c невалидным полем владелец (ввод спецсимволов), обычная покупка:**
- на странице сервиса нажать кнопку "Купить";
- ввести валидный номер карты;
...
**13) Оплата по карте c невалидным полем CVV (ввод 2-ух цифр), обычная покупка**
- на странице сервиса нажать кнопку "Купить";
- ввести валидный номер карты;
...
**14). Оплата по карте c невалидным полем CVV (ввод букв), обычная покупка**
- на странице сервиса нажать кнопку "Купить";
- ввести валидный номер карты;
- в поле "Владелец" ввести валидные данные;
- ввести валидный срок действия карты;
...
**15) Оплата по карте c пустым номером карты, обычная покупка:**
- на странице сервиса нажать кнопку "Купить";
...
**19) Оплата по карте c нулевым номером карты, обычная покупка:**
- на странице сервиса нажать кнопку "Купить";
...
**20) Оплата по карте c нулевым полем "Срок действия карты", обычная покупка:**
- на странице сервиса нажать кнопку "Купить";
...
**21) Оплата по карте c нулевым полем "Владелец", обычная покупка:**
- на странице сервиса нажать кнопку "Купить";
...
**22) Оплата по карте c нулевым полем CVV, обычная покупка:**
- на странице сервиса нажать кнопку "Купить";
